...
# should out-perform agent 7


class Agent8(ImprovedAgent, CombinedPartialAgent):
	def __init__(self, env, pos=None):
		CombinedPartialAgent.__init__(self, env, pos)
	...
	def move(self, env, prey_pos=None, predator_pos=None):
		...
		super(Agent8, self).move(env, prey_pos, predator_pos)
