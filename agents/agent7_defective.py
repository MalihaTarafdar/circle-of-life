...
# agent 7 with defective drone


class Agent7Defective(CombinedPartialDefectiveAgent):
	def __init__(self, env, pos=None):
		super(Agent7Defective, self).__init__(env, pos)
	...
	def move(self, env, prey_pos=None, predator_pos=None):
		...
		super(Agent7Defective, self).move(env, prey_pos, predator_pos)
